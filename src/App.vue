...
import { fetchTextFiles, extractRepoInfo } from './utils/github';
...
async function fetchRepo() {
  ...
  try {
    ...
    if (!Array.isArray(data)) {
      throw new Error('Invalid repository or API response');
    }
  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
    <div class="max-w-5xl mx-auto px-4">
      <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-gray-900 mb-2">GitHub Repository Text Extractor</h1>
        <p class="text-gray-600">Extract and analyze text content from any GitHub repository</p>
      </div>
